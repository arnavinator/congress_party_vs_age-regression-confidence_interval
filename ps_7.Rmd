...
```
A negative coefficient indicates a that as age increases, the nominate_percentile value for a congressmen tends to go decrease (following a straight line), while a positive coefficient indicates a that as age increases, the nominate_percentile value for a congressmen tends to go increase (following a straight line).
...
# filter congress dataset to democrats only for the 116th congress. Then, using
